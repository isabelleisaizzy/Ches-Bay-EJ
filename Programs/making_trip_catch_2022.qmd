...
## Make trip_catch_2022

Joins and cleans [NOAA APAIS 2022](https://www.fisheries.noaa.gov/recreational-fishing-data/recreational-fishing-data-downloads) data for mapping purposes. Also uses active_sites from making_buffer_zip.qmd. For more see izzy_zheng_readme.txt
...
trip_catch_2022 <- trip_catch_2022 |>
  ...
  mutate(site_id = paste(ST,CNTY,INTSITE,sep="")) #site id for joining site info
