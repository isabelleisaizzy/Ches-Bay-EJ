...
# Note that these data are just the site locations. They describe the sites and their
  # associated characteristics. May be able to do some stuff with that, but the
  # really interesting stuff that Matt mentioned is going to come from the angler
  # surveys.
